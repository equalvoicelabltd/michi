 ...
 *
 * 日本最新商品情報頁面
 * - 從 /api/products 讀取 Supabase 商品資料
 * - 支援分類篩選、搜尋、手動 AI 刷新
 * - 設計風格與 buyers/page.tsx 一致
 */
  ...
  return (
    <article className="group border border-stone-200 bg-white hover:border-[#1A237E] transition-all duration-300 flex flex-col">
      ...
      <div className="aspect-[4/3] bg-stone-50 border-b border-stone-100 flex items-center justify-center relative overflow-hidden">
        ...
        {/* Category badge */}
        <div
          className="absolute top-3 left-3 text-white text-[7px] font-black uppercase tracking-[0.3em] px-2 py-1"
      ...
      <div className="p-6 flex flex-col flex-1 space-y-3">
        ...
        {/* AI Summary */}
        {product.ai_summary && (
          <p className="text-[11px] text-stone-500 leading-relaxed line-clamp-3 flex-1">
            {product.ai_summary}
          </p>
        )}
        ...
        <div className="max-w-7xl mx-auto px-8 py-16 md:py-20">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            ...
            <div className="flex flex-col items-start md:items-end gap-3">
              ...
              {refreshMsg && (
                <p className="text-[10px] font-bold text-[#C5A059] tracking-wide">{refreshMsg}</p>
              )}
            </div>
          </div>
        </div>
            ...
            {[
              {
                step: '01',
                title: 'AI 每日搜尋',
                desc: '系統每天自動使用 AI 搜尋日本各大品牌最新商品發佈，涵蓋 6 大分類。',
              },
              {
                step: '02',
                title: '繁中摘要生成',
                desc: 'OpenAI 為每件商品生成繁體中文摘要，包括品牌特色、適合人群及購買價值。',
              },
              {
                step: '03',
                title: '聯絡買手代購',
                desc: '發現心水商品後，前往「找買手」頁面聯絡在日買手，直接安排代購。',
              },
            ].map(({ step, title, desc }) => (
